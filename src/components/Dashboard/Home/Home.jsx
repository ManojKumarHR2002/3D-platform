...
import projects, { getProjects, saveProject } from "../../../services/MyProjects"; // Adjust path if necessary
import sharedProjects from "../../../services/SharedWithMeProjects"; // Adjust path if necessary
  ...
  return (
    <section aria-labelledby="projects-heading">
      <div className="max-h-[86vh] overflow-y-auto scrollbar-hide mt-9">
        {/* My Projects Section */}
        <h2 id="projects-heading" className="text-base font-bold text-white max-md:mt-10">
          My Projects
        </h2>
          ...
          {projects.slice(0, 5).map((project) => (
            ...
            >
              ...
              <div className="flex flex-col self-start mt-3 ml-3 max-md:ml-2.5">
                ...
                <p className="text-sm text-white text-opacity-80">{project.description}</p>
              </div>
            </button>
          ))}
        </div>
        ...
        <h2 className="mt-9 text-base font-bold text-white max-md:mt-10">Shared With Me</h2>
        <div className="grid grid-cols-1 gap-9 mt-7 sm:grid-cols-3 lg:grid-cols-5 max-h-[80vh] overflow-y-auto scrollbar-hide">
