...
export default function ProjectHierarchyPanel({ 
  ...
  return (
    <div className="flex flex-col h-full px-2 py-6 text-sm rounded-xl bg-zinc-900 bg-opacity-80 text-white text-opacity-80">
      ...
      <div className="flex gap-10 self-start mt-3.5 whitespace-nowrap max-md:ml-1 w-full">
        <button 
          className={`px-5 py-2.5 w-[50%] font-semibold rounded-xl ${
            selectedTab === 'objects' ? 'bg-zinc-700' : 'bg-transparent'
          } shadow-[0px_2px_4px_rgba(0,0,0,0.1)] focus:outline-none`}
      ...
      <div className="flex gap-3.5 px-2.5 py-2 mt-4 mr-2.5 text-xs text-center whitespace-nowrap rounded-md bg-zinc-700 shadow-[0px_2px_4px_rgba(0,0,0,0.12)] text-white text-opacity-80">
        <img
          loading="lazy"
      ...
      <div className="shrink-0 h-px border border-solid border-neutral-700" />
      <nav className="flex flex-col gap-3 mt-3" aria-label="Canvas navigation">
        <button className="flex gap-5 self-start pl-5 py-2 rounded-lg bg-transparent hover:bg-zinc-700">
          <img
            loading="lazy"
        ...
        <button 
          ...
          disabled={uploading}
          className="flex gap-5 self-start pl-5 py-2 rounded-lg bg-transparent hover:bg-zinc-700"
        >
          <img
            loading="lazy"
